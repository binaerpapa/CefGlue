...
namespace Xilium.CefGlue.Demo.Avalonia
{
    public partial class BrowserView : UserControl
    {
        ...
        public async void EvaluateJavascript()
        {
            ...
            result.Write("; " + string.Join(", ",
                (await browser.EvaluateJavaScript<ExpandoObject>(
                    "return (function() { return { a: 'valueA', b: 1, c: true } })()"))
        ...
        public void BindJavascriptObject()
        {
            ...
            var script = "(function () {" +
                         "let calls = [];" +
                         string.Join("",
                             methods.Select(m => $"calls.push({{ name: '{m}', promise: {TestObject}.{m}() }});")) +
